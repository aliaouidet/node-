...
const CartProductItem = ({ product }) => {
    ...
    return (
        ...
        <article className="flex flex-col gap-3 bg-white rounded-xl shadow-md text-center mb-6">
            ...
            <div className="text-lg">{product.libelle}</div>
            <div className="text-2xl font-semibold mt-auto">{product.prix} dt </div>
